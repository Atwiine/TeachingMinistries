...
import com.example.tushome.Adapters.SeeFeebackAdapter;
...
public class SeeFeedbackBooks extends AppCompatActivity {

    RecyclerView recyclerView;
    List<AuthorModel> mData;
    SeeFeebackAdapter adapter;
    TextView heading;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new SeeFeebackAdapter(this, mData);
    ...
    private void loadAuthorBooks() {
        final ProgressDialog progressDialog = new ProgressDialog(SeeFeedbackBooks.this);
                        ...
                        if (tips.length() == 0) {
                            ...
                            next.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent aa = new Intent(SeeFeedbackBooks.this, AuthorActivity.class);
                                    startActivity(aa);
                                    finish();
                                    no_message.dismiss();
                                }
                            ...
                            adapter = new SeeFeebackAdapter(SeeFeedbackBooks.this, mData);
                            recyclerView.setAdapter(adapter);
                        }
    ...
    public void back(View view) {
        startActivity(new Intent(SeeFeedbackBooks.this, AuthorActivity.class));
        finish();
    }
}