...
import com.example.tushome.Adapters.AuthorAdapter;
...
public class AuthorsBooks extends AppCompatActivity {
...
//        error_message = findViewById(R.id.error_message_balance);
        ...
        adapter = new AuthorAdapter(this, mData);
    ...
    private void loadAuthorBooks() {
        final ProgressDialog progressDialog = new ProgressDialog(AuthorsBooks.this);
                        ...
                        if (tips.length() == 0) {
                            ...
                            next.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent aa = new Intent(AuthorsBooks.this, AuthorActivity.class);
                                    startActivity(aa);
                                    finish();
                                    no_message.dismiss();
                                }
                            ...
                            for (int i = 0; i < tips.length(); i++) {
                                ...
                                String suspend = inputsObjects.getString("suspend");
                                ...
                                AuthorModel inputsModel = new AuthorModel(id,
                                        ...
                                        image,
                                        preview,
                                        author,reason, status,suspend);
                                mData.add(inputsModel);
                            }
                            adapter = new AuthorAdapter(AuthorsBooks.this, mData);
                            recyclerView.setAdapter(adapter);
                        }
    ...
    public void back(View view) {
        startActivity(new Intent(AuthorsBooks.this, AuthorActivity.class));
        finish();
    }

    public void tryAgain(View view) {
        startActivity(new Intent(AuthorsBooks.this, AuthorsBooks.class));
        finish();
    }
}