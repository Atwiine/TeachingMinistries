...
public class ManageRewards extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        heading.setText("Manger rewards");
    ...
    private void loadRewardRequests() {
        final ProgressDialog progressDialog = new ProgressDialog(ManageRewards.this);
        progressDialog.setMessage("Loading requests please wait...");
        progressDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, urls.LOAD_REWARD_REQUESTS,
                response -> {
...
//                                    Intent aa = new Intent(ManageRewards.this, MainAdmin.class);
//                                    startActivity(aa);
//                                    finish();
                                    no_message.dismiss();
                                }
                            ...
                            adapter = new ManageRewardsAdapter(ManageRewards.this, mData);
                            recyclerView.setAdapter(adapter);
                        }
        ...
        Volley.newRequestQueue(ManageRewards.this).add(stringRequest);
    }


    public void back(View view) {
        startActivity(new Intent(ManageRewards.this, MainAdmin.class));
        finish();
    }


    public void openRewardRecords(View view) {
        startActivity(new Intent(ManageRewards.this, AllRewardRequests.class));
    }
}