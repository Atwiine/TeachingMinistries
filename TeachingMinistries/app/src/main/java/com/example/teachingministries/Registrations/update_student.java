...
//                if (!full_name_val.isEmpty() && !usernames.isEmpty() && !pass.isEmpty()) {
                ...
                String gg = getIntent().getStringExtra("id");
...
//                }
        ...
        gg = getIntent().getStringExtra("id");
...
//    }
    ...
    private void getUserDetail(String gg) {
        final ProgressDialog dialog = new ProgressDialog(this);
        dialog.setMessage("Please wait as we fetch student details");
        dialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, urls.STUDENTDETS_URL,
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (users.length() == 0) {
                                dialog.dismiss();
                                Toast.makeText(update_student.this, "No results found", Toast.LENGTH_SHORT).show();
                            } else {
                                for (int i = 0; i < users.length(); i++) {
                                    ...
                                    String fullnames = object.getString("names");
                            ...
                            Toast.makeText(update_student.this, "Error something went wrong", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        dialog.dismiss();
                        Toast.makeText(update_student.this, "Error something went wrong, please try again", Toast.LENGTH_SHORT).show();
    ...
    private void SaveEditDetail(String gg) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, urls.EDITSTUDENTACCOUNT,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                Toast.makeText(update_student.this, "student update success", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(update_student.this, MainActivity.class));
                                finish();
                            }
                            ...
                            Toast.makeText(update_student.this, "Something went wrong please try again", Toast.LENGTH_SHORT).show();
                        }
    ...
    public void goback(View view) {
        if (TextUtils.isEmpty(gg)) {
            startActivity(new Intent(update_student.this, Settings.class));
        } else {
            startActivity(new Intent(update_student.this, MainActivity.class));
        }
    }
