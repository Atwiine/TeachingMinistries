...
public class Graduation extends AppCompatActivity {
    ...
    String fileName = "Graduation-class-alpha-4";
...
//        total = findViewById(R.id.total);
        ...
        getdate_from.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Graduation.this, "From: " + fromDates.getText().toString(), Toast.LENGTH_SHORT).show();
        ...
        getdate_to.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Graduation.this, "To: " + toDates.getText().toString(), Toast.LENGTH_SHORT).show();
        ...
        btnGetSelected.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String wm = "GraduationAdapter";
                String tt = "Grad";
                Intent intent = new Intent(Graduation.this, SendMessage.class);
        ...
        adapter = new GraduationAdapter(this, mData);
        recyclerView.setAdapter(adapter);

//        loadtotalGradstudentsTrack();
        /*get the dates from filter*/
        String fromDatess = fromDates.getText().toString().trim();
        String toDatess = toDates.getText().toString().trim();

        loadGradstudentsTrack(fromDatess, toDatess);


        /*THE EXPORTING PART NO SEEING THE TEACHING AND THE GROUP MESSAGING NOT WORKING*/
    }


    @RequiresApi(api = Build.VERSION_CODES.KITKAT)
    private void loadGradstudentsTrack(String fromDatess, String toDatess) {
        final ProgressDialog progressDialog = new ProgressDialog(Graduation.this);
        progressDialog.setMessage("Loading graduated participants, please wait....");
        progressDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, urls.LOAD_GRADUATED_STUDENTS,
                response -> {
                    ...
                    try {
                        ...
                        if (tips.length() == 0) {
                            ...
                            adapter = new GraduationAdapter(Graduation.this, mData);
                            recyclerView.setAdapter(adapter);
                        }
...
//            Toast.makeText(this, "Sond try agn " + error.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void openPassStudents(View view) {
        startActivity(new Intent(Graduation.this, PassStudents.class));

    }

    public void back(View view) {
        startActivity(new Intent(Graduation.this, TrackAttendance1.class));
        finish();
    }

    public void openMissedStudents(View view) {
        startActivity(new Intent(Graduation.this, MissedStudents.class));
    }
    ...
    public void openToBeBasptisedStudents(View view) {
        startActivity(new Intent(Graduation.this, ToBeBaptised.class));
    }
    ...
    private void exporttrackStudents(String fromDatess, String toDatess) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, urls.EXPORT_GRADUATION,
                response -> {
                    try {
                        Log.i("tagconvertstr", "[" + response + "]");
                        JSONArray tips = new JSONArray(response);
...
//            show_error.setText(error.toString());
    ...
    public void exportFile() {
        try {
            ...
            Uri downloadUri = Uri.parse(urls.download_graduation);
    ...
    public void open_intents(View view) {
        ...
        try {
            FileOpen.openFile(Graduation.this, myFile);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
