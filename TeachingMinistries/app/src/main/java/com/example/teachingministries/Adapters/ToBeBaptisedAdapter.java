...
public class ToBeBaptisedAdapter extends RecyclerView.Adapter<ToBeBaptisedAdapter.AuthorViewHolder> {
    Context context;
    ...
    public ToBeBaptisedAdapter(Context context, List<Track1Model> mData) {
    ...
    public AuthorViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        view = LayoutInflater.from(context).inflate(R.layout.item_to_be_baptised, null, false);
       ...
       if (holder.current_teacher.getText().toString().equals(teacher)) {
                        ...
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    if (success.equals("1")) {
                                        Toast.makeText(context, "successful", Toast.LENGTH_LONG).show();
                                        holder.track_attendance.setText("Not baptised");
                                    }
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                    Toast.makeText(context, "Participant not registered as baptised, please try again", Toast.LENGTH_LONG).show();
        ...
        holder.sms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alertDialogBuilder.setMessage("Are you sure,You wanted to send a messages to the selected participant");
