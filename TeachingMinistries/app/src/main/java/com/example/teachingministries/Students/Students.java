...
public class Students extends AppCompatActivity {
    ...
    String fileName = "Registered-participants-alpha-1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getdate_from.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Students.this, "From: " + fromDates.getText().toString(), Toast.LENGTH_SHORT).show();
        ...
        getdate_to.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Students.this, "To: " + toDates.getText().toString(), Toast.LENGTH_SHORT).show();
        ...
        btnGetSelected.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String tt = "Stud";
                Intent intent = new Intent(Students.this, SendMessage.class);
        ...
        othersCheck = getIntent().getStringExtra("selected_alpha");

        /*get the dates from filter*/
        String fromDatess = fromDates.getText().toString().trim();
        String toDatess = toDates.getText().toString().trim();

        /*load the received students*/
        if (!TextUtils.isEmpty(othersCheck) ){
            loadReceivedStudents(othersCheck,fromDatess, toDatess);
            heading.setText(othersCheck + " received participants");

        }else {
            loadRegisteredStudents(fromDatess, toDatess);
        }
    ...
    private void loadRegisteredStudents(String fromDatess, String toDatess) {
        final ProgressDialog progressDialog = new ProgressDialog(Students.this);
        progressDialog.setMessage("Loading registered participants, please wait....");
        progressDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, urls.LOAD_REGISTERED_STUDENTS,
                response -> {
                    ...
                    try {
                        ...
                        if (tips.length() == 0) {
                            ...
                            adapter = new StudentsAdapter(Students.this, mData);
                            recyclerView.setAdapter(adapter);
                        }
    ...
    @RequiresApi(api = Build.VERSION_CODES.KITKAT)
    private void loadReceivedStudents(String othersCheck,String fromDatess, String toDatess) {
        final ProgressDialog progressDialog = new ProgressDialog(Students.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, urls.LOAD_REGISTERED_STUDENTS,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("teacher", othersCheck);
                params.put("todate", toDatess);
                params.put("fromdate", fromDatess);
                return params;
            }
    ...
    public void sendFilterDates(View view) {
        ...
        if (fromDatesss.isEmpty() && toDatesss.isEmpty()) {
            ...
            String fromDatess = fromDates.getText().toString().trim();
            String toDatess = toDates.getText().toString().trim();
//            loadtotalstudentsTrack(fromDatess, toDatess);
...
//                        Toast.makeText(TrackAttendance1.this, "from " + fromDatess, Toast.LENGTH_SHORT).show();
//                        Toast.makeText(TrackAttendance1.this, "to " + toDatess, Toast.LENGTH_SHORT).show();
//                        Toast.makeText(TrackAttendance1.this, "teacher " + getType, Toast.LENGTH_SHORT).show();
                    }
    ...
    private void exporttrackStudents(String fromDatess, String toDatess) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, urls.EXPORT_REGISTERED_STUDENTS,
                response -> {
...
//            show_error.setText(error.toString());
    ...
    public void exportFile() {
                        ...
                        try {
                            ...
                            Uri downloadUri = Uri.parse(urls.download_registered_students);
    ...
    public void open_intents(View view) {
        ...
        try {
            FileOpen.openFile(Students.this, myFile);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
